                ...
                try:
                    with open(filepath, 'r') as f:
                        ...
                        if not isinstance(data, list) or not all(isinstance(x, (float, int)) for x in data):
                            log(f"Corrupted file detected: {filepath}")
                            valid = False
        ...
        for filename in os.listdir(directory):
            if filename.endswith(".txt"):
                ...
                with open(filepath, 'r') as file:
                    try:
                        # Validate content is a Python list of numbers
                        data = eval(file.read())
                        ...
                        log(f"Skipping corrupted file {filepath}: {e}")
    except Exception as e:
        log(f"Error reading directory {directory}: {e}")
